...
<head>
    ...
    <style>
        ...
        .nav-link.active {
    border: 1px solid black; /* Customize the color */
    color: #007bff; /* Optionally change text color */
}
...
<body>
    <div class="header">
        ...
        <div class="nav-scroller bg-white pb-5 shadow-sm mt-5">
            <nav class="nav ml-3">
                <a class="dash nav-link {{ Route::is('home') ? 'active' : '' }}" href="{{ route('home') }}">
                    <i class="fa-solid fa-gauge"></i> Dashboard
                </a>
                <a class="dash dl nav-link {{ Route::is('orders') ? 'active' : '' }}" href="#">
                    <i class="fa-solid fa-box-open"></i> Orders
                </a>
                <a class="dash ad nav-link {{ Route::is('Userprofile.show') ? 'active' : '' }}" href="{{ route('Userprofile.show') }}">
                    <i class="fa-solid fa-user"></i> Profile
                </a>
                <a class="dash ad nav-link {{ Route::is('cart') ? 'active' : '' }}" href="#">
                    <i class="fa-solid fa-cart-shopping"></i> Cart
                </a>
                <a class="dash ch nav-link {{ Route::is('pending') ? 'active' : '' }}" href="#">
