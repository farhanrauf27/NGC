            ...
            <div class="card-deck">
               <div class="card" style="max-width: 300px;">
                   ...
                   <div class="card-body">
                       ...
                       <hr>
                       <h6 class="font-weight-bolder">Price:&nbsp;&nbsp;&nbsp;<span class="blockquote font-weight-normal">Rs. {{ $product->price }}</span></h6>
                       <br>
                       <h6 class="font-weight-bolder">Brand:&nbsp;&nbsp;&nbsp;<span class="blockquote font-weight-normal">{{ $product->brand }} </span></h6>
                       <br>
                       <h6 class="font-weight-bolder">Type:&nbsp;&nbsp;&nbsp;<span class="blockquote font-weight-normal">{{ ucfirst($product->type) }}</span></h6>
                   </div>
